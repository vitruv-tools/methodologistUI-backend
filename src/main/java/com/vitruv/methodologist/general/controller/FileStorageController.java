...
/**
 * REST controller for handling file storage operations.
 * Provides endpoints for uploading, downloading, and managing stored files.
 */
@RestController
@RequestMapping("/api/")
@Validated
public class FileStorageController {
    ...
    public ResponseTemplateDto<String> upload(
        ...
        return ResponseTemplateDto.<String>builder()
