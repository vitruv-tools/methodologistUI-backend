...
/**
 * Spring Data repository interface for managing StoredFile entities.
 * Provides CRUD operations and custom queries for StoredFile persistence.
 */
public interface FileStorageRepository extends CrudRepository<FileStorage, Long> {

    /**
     * Finds a stored file by its SHA-256 hash and size in bytes.
     * Used to check for duplicate files in storage.
     *
