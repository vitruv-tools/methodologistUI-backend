...
public class SmtpMailServiceTest {
    ...
    void constructor_withNullFromEmail_throwsNullPointerException() {
        assertThrows(NullPointerException.class, () ->
                new SmtpMailService(
                        "localhost", 587, "user", "pass",
                        null, "Name",
                        true, false, 5000, 5000, 5000)
        );
    }
    ...
    void sendOtpMail_withNullRecipientName_handlesGracefully() {
        ...
        assertDoesNotThrow(() ->
                smtpMailService.sendOtpMail(recipientEmail, null, "123456", 5)
        );
    ...
    void sendOtpMail_withBlankRecipientName_handlesGracefully() {
        ...
        assertDoesNotThrow(() ->
                smtpMailService.sendOtpMail(recipientEmail, "   ", "123456", 5)
        );
    ...
    void sendForgotPasswordMail_success() {
        ...
        assertDoesNotThrow(() ->
                smtpMailService.sendForgotPasswordMail(recipientEmail, recipientName, "new-secure-pass")
        );
