...
/**
 * A supplier that memoizes its result. The first call to {@link #get()} computes the value
 * using the provided supplier, and subsequent calls return the same value.
 *
...
public class MemoizedSupplier<T> implements Supplier<T> {
    ...
    /**
     * Returns the memoized value. If it has not been computed yet, it is computed
     * using the underlying supplier.
     *
