 ...
 * tools.vitruv.methodologist.config.KeycloakAuthentication.ParsedToken} object for easier access.
 */
@Getter
public class KeycloakAuthentication extends JwtAuthenticationToken {
   ...
   * tools.vitruv.methodologist.config.KeycloakAuthentication.ParsedToken}.
   *
