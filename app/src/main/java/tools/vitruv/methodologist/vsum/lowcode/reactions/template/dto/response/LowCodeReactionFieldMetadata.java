...
public class LowCodeReactionFieldMetadata {
  ...
  /**
   * The allowable values for the field.
   ...
   * \@Size(min=?, max=?) Applies to: String length, arrays length, collections size.
   */
  ...
  /**
   * The minimum decimal value of the field.
  ...
  /**
   * The maximum decimal value of the field.
  ...
  /**
   * The pattern for the field value.
   * \@Pattern(regexp=?)
   */
