...
public class LowCodeReactionMetadataService {
  ...
  private List<LowCodeReactionFieldMetadata> getLowCodeReactionFieldMetadata(
  ...
  private boolean isPublicTemplate(LowCodeReactionRequestBase dto) {
    ReactionMetadata reactionMetadata = dto.getClass().getAnnotation(ReactionMetadata.class);
    return reactionMetadata == null || !reactionMetadata.hide();
  }
